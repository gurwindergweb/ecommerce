  ...
  <div class="agile-sometext py-md-5 py-sm-4 py-3">
    <div class="container">
      ...
      <div class="sub-some child-momu mt-4">
        ...
        <ul>
          <li>
            <img src="<?= Yii :: $app->view->theme->baseUrl ?>/images/pay2.png" alt="">
          </li>
          <li>
            <img src="<?= Yii :: $app->view->theme->baseUrl ?>/images/pay5.png" alt="">
          </li>
          <li>
            <img src="<?= Yii :: $app->view->theme->baseUrl ?>/images/pay1.png" alt="">
          </li>
          <li>
            <img src="<?= Yii :: $app->view->theme->baseUrl ?>/images/pay4.png" alt="">
          </li>
          <li>
            <img src="<?= Yii :: $app->view->theme->baseUrl ?>/images/pay6.png" alt="">
          </li>
          <li>
            <img src="<?= Yii :: $app->view->theme->baseUrl ?>/images/pay3.png" alt="">
          </li>
          <li>
            <img src="<?= Yii :: $app->view->theme->baseUrl ?>/images/pay7.png" alt="">
          </li>
          <li>
            <img src="<?= Yii :: $app->view->theme->baseUrl ?>/images/pay8.png" alt="">
          </li>
          <li>
            <img src="<?= Yii :: $app->view->theme->baseUrl ?>/images/pay9.png" alt="">
          </li>
        </ul>
      </div>
      <!-- //payment -->
